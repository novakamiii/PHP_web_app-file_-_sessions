...
$(function () {
  ...
  $(document).on("click", "#loginCartNotif", function (e) {
  ...
  $(function () {
    window.openAuthModal = function (mode) {
      ...
      if (!$modal.length) return console.error("Modal not found in DOM");
  ...
  $(document).on("shown.bs.modal", "#authModal", function () {
    ...
    $(document)
      .off("keypress", "#loginEmail, #signupEmail")
      .on("keypress", "#loginEmail, #signupEmail", function (e) {
    ...
    $(document)
      .off("click", "#openSignup")
      .on("click", "#openSignup", function (e) {
        e.preventDefault();
        $("#loginFormContainer").addClass("d-none");
        $("#signupFormContainer").removeClass("d-none");
        $("#modalTitle").text("Sign Up");
      ...
      .on("submit", "#signupForm", function (e) {
        ...
        if (password.includes(" ") || password.length < 7) {
          $("#signupPasswordError").text(
            "Password must be at least 7 characters long and contain no spaces."
          );
          valid = false;
        }
        if (password !== confirm) {
        ...
        if (
          $("#signupEmailError").text().includes("already") ||
          $("#contactError").text().includes("already")
        ) {
          valid = false;
        }
    ...
    $(document)
      .off("input", "#signupEmail")
      .on("input", "#signupEmail", function () {
